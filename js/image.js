!function() {
    ...
    function d(e) {
          ...
          , i = function() {
            function r() {
                var e = {
                  ...
                  , t = void 0
                  , o = void 0;
                u.container && (u.container instanceof Object ? (t = (e = g({}, e, u.container)).width - e.left - e.right - 2 * u.margin,
                o = e.height - e.top - e.bottom - 2 * u.margin) : (r = (i = (h(u.container) ? u.container : document.querySelector(u.container)).getBoundingClientRect()).width,
                m = i.height,
                d = i.left,
                a = i.top,
                e = g({}, e, {
            ...
            return new n(function(e) {
                if (d && -1 === m.indexOf(d))
                    ...
                    function t() {
                        ...
                        s.original.dispatchEvent(E("medium-zoom:opened", {
                            detail: {
                                zoom: f
                            }
                        })),
                    ...
                    if (s.zoomed)
                        ...
                        u.template && (i = h(u.template) ? u.template : document.querySelector(u.template),
                        ...
                        s.original.getAttribute("data-zoom-src") ? (s.zoomedHd = s.zoomed.cloneNode(),
          ...
          , a = function() {
            return new n(function(t) {
                ...
                !c && s.original ? (e = function e() {
                    ...
                    s.original.dispatchEvent(E("medium-zoom:closed", {
                        detail: {
                            zoom: f
                        }
                    })),
                ...
                s.template && (s.template.style.transition = "opacity 150ms",
                s.template.style.opacity = 0),
                s.original.dispatchEvent(E("medium-zoom:close", {
                    detail: {
                        zoom: f
                    }
                })),
        ...
        document.addEventListener("scroll", function() {
            var e;
            !c && s.original && (e = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0,
        ...
        var f = {
            ...
            update: function() {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}
                  , t = e;
                return e.background && (p.style.background = e.background),
                e.container && e.container instanceof Object && (t.container = g({}, u.container, e.container)),
                e.template && (e = h(e.template) ? e.template : document.querySelector(e.template),
                t.template = e),
                u = g({}, u, t),
            ...
            detach: function() {
                ...
                return i.forEach(function(e) {
                    ...
                    e.dispatchEvent(E("medium-zoom:detach", {
                        detail: {
                            zoom: f
                        }
                    }))
    ...
    var g = Object.assign || function(e) {
      ...
      , E = function(e, t) {
        ...
        return t.initCustomEvent(e, o.bubbles, o.cancelable, o.detail),
        t
    };
    var e, o, n, i;
    e = ".medium-zoom-overlay{position:fixed;top:0;right:0;bottom:0;left:0;opacity:0;transition:opacity .3s;will-change:opacity}.medium-zoom--opened .medium-zoom-overlay{cursor:pointer;cursor:zoom-out;opacity:1}.medium-zoom-image{cursor:pointer;cursor:zoom-in;transition:transform .3s cubic-bezier(.2,0,.2,1)!important}.medium-zoom-image--hidden{visibility:hidden}.medium-zoom-image--opened{position:relative;cursor:pointer;cursor:zoom-out;will-change:transform}",
    i = (o = void 0 === o ? {} : o).insertAt,
    e && "undefined" != typeof document && (n = document.head || document.getElementsByTagName("head")[0],
